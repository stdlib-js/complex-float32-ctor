...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/complex-float32-ctor/tags). For example,

```javascript
Complex64 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-ctor@v0.0.2-umd/browser.js' )
```
